# Generated by Django 2.0.2 on 2018-05-12 18:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.DateTimeField(default=datetime.datetime(2018, 5, 12, 18, 32, 37, 560650, tzinfo=utc), verbose_name='Fecha Publicacion')),
                ('image', models.ImageField(blank=True, null=True, upload_to='blogs', verbose_name='La Imagen')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Creacion')),
                ('update', models.DateTimeField(auto_now=True, verbose_name='Fecha de edicion')),
